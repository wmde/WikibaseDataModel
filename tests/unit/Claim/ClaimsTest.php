...
class ClaimsTest extends \PHPUnit_Framework_TestCase {
	...
	public function testArrayObjectNotConstructedFromObject() {
		$statement1 = $this->makeClaim( new PropertyNoValueSnak( 1 ) );
		$statement2 = $this->makeClaim( new PropertyNoValueSnak( 2 ) );
	...
	public function testAddClaim() {
		...
		$this->assertEquals( 0, $statements->indexOf( $statement3 ), 'Inserting claim at the beginning failed' );
		...
		$this->assertEquals( 1, $statements->indexOf( $statement4 ), 'Inserting claim at index 1 failed' );
		...
		$this->assertEquals( 4, $statements->indexOf( $statement5 ), 'Appending claim by specifying an index out of bounds failed' );
	}
